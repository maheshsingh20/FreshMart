...
namespace Backend.Data.Migrations
{
    ...
    [Migration("20260317000000_AddUserIsActive")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Coupon", b =>
                {
                    ...
                    b.Property<string>("DiscountType").IsRequired().HasColumnType("nvarchar(max)");
                    b.Property<decimal>("DiscountValue").HasColumnType("decimal(18,2)");
                    b.Property<DateTime?>("ExpiresAt").HasColumnType("datetime2");
                    b.Property<bool>("IsActive").HasColumnType("bit");
                    b.Property<decimal>("MinOrderAmount").HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Backend.Models.Order", b =>
                {
                    ...
                    b.Property<string>("DeliveryAddress").IsRequired().HasColumnType("nvarchar(max)");
                    b.Property<decimal>("DeliveryFee").HasColumnType("decimal(18,2)");
                    b.Property<decimal>("DiscountAmount").HasColumnType("decimal(18,2)");
                    b.Property<DateTime?>("EstimatedDelivery").HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Backend.Models.Product", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
                    b.Property<double>("AverageRating").HasColumnType("float");
                    b.Property<string>("Brand").HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("DiscountPercent").HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("Backend.Models.SupportMessage", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
                    b.Property<DateTime>("CreatedAt").HasColumnType("datetime2");
                    b.Property<bool>("IsStaff").HasColumnType("bit");
                    b.Property<string>("Message").IsRequired().HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SenderRole").IsRequired().HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Backend.Models.SupportTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt").HasColumnType("datetime2");
                    b.Property<string>("CustomerEmail").IsRequired().HasColumnType("nvarchar(max)");
                    b.Property<Guid>("CustomerId").HasColumnType("uniqueidentifier");
                    b.Property<string>("CustomerName").IsRequired().HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Backend.Models.Cart", b =>
                {
                    b.HasOne("Backend.Models.AppUser", "Customer").WithOne("Cart")
                        .HasForeignKey("Backend.Models.Cart", "CustomerId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Customer");
                });

            modelBuilder.Entity("Backend.Models.CartItem", b =>
                {
                    b.HasOne("Backend.Models.Cart", "Cart").WithMany("Items")
                        .HasForeignKey("CartId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("Backend.Models.Product", "Product").WithMany()
            ...
            modelBuilder.Entity("Backend.Models.Category", b =>
                {
                    b.HasOne("Backend.Models.Category", "ParentCategory").WithMany()
            ...
            modelBuilder.Entity("Backend.Models.Notification", b =>
                {
                    b.HasOne("Backend.Models.AppUser", "User").WithMany()
            ...
            modelBuilder.Entity("Backend.Models.Order", b =>
                {
                    b.HasOne("Backend.Models.AppUser", "Customer").WithMany("Orders")
            ...
            modelBuilder.Entity("Backend.Models.OrderItem", b =>
                {
                    b.HasOne("Backend.Models.Order", "Order").WithMany("Items")
            ...
            modelBuilder.Entity("Backend.Models.Product", b =>
                {
                    b.HasOne("Backend.Models.Category", "Category").WithMany("Products")
                        .HasForeignKey("CategoryId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Category");
                });

            modelBuilder.Entity("Backend.Models.Review", b =>
                {
                    b.HasOne("Backend.Models.AppUser", "Customer").WithMany()
                        .HasForeignKey("CustomerId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("Backend.Models.Product", "Product").WithMany()
                        .HasForeignKey("ProductId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Customer");
            ...
            modelBuilder.Entity("Backend.Models.SupportMessage", b =>
                {
                    b.HasOne("Backend.Models.SupportTicket", "Ticket").WithMany("Messages")
                        .HasForeignKey("TicketId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Ticket");
                });
            ...
            modelBuilder.Entity("Backend.Models.Cart", b => { b.Navigation("Items"); });
            modelBuilder.Entity("Backend.Models.Category", b => { b.Navigation("Products"); });
            modelBuilder.Entity("Backend.Models.Order", b => { b.Navigation("Items"); });
            modelBuilder.Entity("Backend.Models.SupportTicket", b => { b.Navigation("Messages"); });
